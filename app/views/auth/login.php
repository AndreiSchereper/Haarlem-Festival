            ...
            <div class="container">
                <div class="row d-flex justify-content-center">
                    <div class="col-sm-12 col-md-6 col-lg-4 mx-auto">
                        ...
                        <!-- Sign In Form -->
                        <form class="sign-in-form" action="/auth/login" method="POST">
                        ...
                        <form class="register-form" action="/auth/register" method="POST">
                            <div class="d-grid">
                                <button class="register-btn btn btn-lg btn-primary btn-login text-uppercase fw-bold mb-2" name="forgotPassword" type="submit">Forgot Password?</button>
                            </div>
                        </form>
                    </div>
                </div>
